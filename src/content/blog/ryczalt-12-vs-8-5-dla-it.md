---
title: "Ryczałt 12% czy 8,5% dla programisty? Pełna analiza stawek IT w 2026"
description: "Programowanie objęte jest stawką 12%, ale część usług IT mieści się w 8,5%, a niektóre role w 14% lub 15%. Sprawdź, gdzie przebiega granica i jak dobrać PKWiU."
seoTitle: "Ryczałt 12% czy 8,5% dla programisty w 2026"
seoDescription: "Programowanie objęte jest stawką 12%, ale część usług IT mieści się w 8,5%. Sprawdź, gdzie przebiega granica i jak dobrać PKWiU."
pubDate: 2026-05-22
updatedDate: 2026-08-22
category: "Ryczałt"
tags: ["ryczałt", "IT", "programiści", "PKWiU", "stawki", "2026"]
readingTime: 12
author: "tomasz-bajorek"
cover: "ryczalt-12-vs-8-5-dla-it.jpg"
summary:
  - "Stawka <strong>12%</strong> obejmuje usługi związane z oprogramowaniem i doradztwem w zakresie oprogramowania oraz sprzętu, wskazane wprost w art. 12 ust. 1 pkt 2b ustawy o ryczałcie."
  - "Stawka <strong>8,5%</strong> to stawka dla działalności usługowej, która nie została wymieniona w żadnej innej pozycji. To nie jest automatyczna alternatywa dla 12%."
  - "Uwaga na stawki pośrednie: <strong>14%</strong> dla specjalistycznego projektowania i <strong>15%</strong> dla doradztwa związanego z zarządzaniem oraz usług reklamowych."
  - "O stawce decyduje <strong>PKWiU konkretnej usługi</strong>, a nie branża ani kod PKD wpisany w CEIDG."
  - "Różnica między 8,5% a 12% przy przychodzie 240 000 zł to około <strong>8 000 zł rocznie</strong>."
---
...
<aside class="prose-cta">
  <div class="prose-cta__text">
    <p class="prose-cta__title">Szukasz księgowego IT?</p>
    <p class="prose-cta__lede">Dobieramy stawkę ryczałtu do faktycznego zakresu usług, prowadzimy ewidencję IP Box i rozliczamy faktury dla klientów zagranicznych.</p>
  </div>
  <a class="prose-cta__btn" href="/ksiegowosc-dla-programistow">
    <span>Sprawdź naszą ofertę dla programistów</span>
...
1. **Umowa rozdziela usługi**, jeśli faktycznie świadczysz różne rodzaje prac. Jeden zbiorczy zapis „usługi IT" utrudnia obronę każdej klasyfikacji.
2. **Faktura zawiera precyzyjny opis usługi.** Wskazanie PKWiU nie jest obowiązkowe, ale bardzo pomaga.
3. **Ewidencja przychodów rozdziela wpływy według stawek.** Jeśli stosujesz dwie stawki, ewidencja musi to odzwierciedlać, a przy braku wyodrębnienia grozi zastosowanie stawki najwyższej.
4. **Podstawą podziału jest coś weryfikowalnego**, na przykład protokół czasu pracy albo zestawienie zadań.
...
**Czy mogę stosować dwie stawki jednocześnie?**
Tak, jeśli świadczysz różne usługi. Ewidencja przychodów musi je jednak wyraźnie rozdzielać. Jeśli nie da się przypisać przychodu do konkretnej stawki, ryzykujesz opodatkowanie całości według stawki najwyższej.

**Czy PKWiU musi być na fakturze?**
Nie musi. Wystarczy precyzyjny opis usługi. PKWiU jest istotne przede wszystkim po stronie ewidencji i ewentualnego postępowania.

**Czy umowa B2B musi wskazywać PKWiU?**
Nie ma takiego obowiązku, ale jeśli wskazuje, stanowi to dodatkowy argument przy wykazywaniu klasyfikacji.

**Czy mogę zmienić stawkę w trakcie roku?**
Tak, jeśli faktycznie zmienia się charakter świadczonych usług. Nową stawkę stosujesz od momentu zmiany, a ewidencja musi to pokazywać. Nie można natomiast zmienić stawki wstecznie tylko dlatego, że druga wydaje się korzystniejsza.

**Czy kod PKD w CEIDG ma znaczenie dla stawki?**
Bezpośrednio nie. O stawce decyduje PKWiU konkretnej usługi. Rażąca rozbieżność między PKD a stosowaną stawką może jednak zwrócić uwagę urzędu.
...
- [Podatki.gov.pl - ryczałt od przychodów ewidencjonowanych](https://www.podatki.gov.pl/pit/ryczalt-od-przychodow-ewidencjonowanych/) - informacje Ministerstwa Finansów.
- [Krajowa Informacja Skarbowa](https://www.kis.gov.pl/zalatwianie-spraw/wydawanie-interpretacji) - zasady składania wniosków o interpretację indywidualną.
- [GUS - Polska Klasyfikacja Wyrobów i Usług](https://stat.gov.pl/Klasyfikacje/) - pełna klasyfikacja PKWiU 2015 oraz procedura wydawania opinii klasyfikacyjnych.
