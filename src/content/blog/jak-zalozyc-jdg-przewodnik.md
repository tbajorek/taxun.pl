---
title: "Jak założyć JDG w 2026 - kompletny przewodnik krok po kroku"
description: "Praktyczny przewodnik po założeniu jednoosobowej działalności gospodarczej w 2026 roku. Forma opodatkowania, ZUS, VAT, PKD, KSeF, konto firmowe i pierwsze 90 dni."
seoTitle: "Jak założyć JDG w 2026 - przewodnik"
seoDescription: "Przewodnik po założeniu jednoosobowej działalności w 2026 roku. Forma opodatkowania, ZUS, VAT, PKD, KSeF i konto firmowe."
pubDate: 2026-05-12
updatedDate: 2026-08-22
category: "JDG"
tags: ["JDG", "zakładanie firmy", "CEIDG", "ZUS", "VAT", "ryczałt", "skala podatkowa", "podatek liniowy"]
readingTime: 14
featured: true
author: "tomasz-bajorek"
cover: "jak-zalozyc-jdg-przewodnik.jpg"
summary:
  - "Rejestracja JDG zajmuje kilkanaście minut, ale <strong>cztery decyzje podejmowane przed wysłaniem CEIDG-1</strong> przesądzają o wysokości podatku na cały rok."
  - "<strong>Ryczałt</strong> (najczęściej 8,5% lub 12%) sprawdza się przy wysokim przychodzie i niskich kosztach, typowo w IT, marketingu i konsultingu."
  - "<strong>Skala 12% i 32%</strong> daje kwotę wolną 30 000 zł, wspólne rozliczenie i pełne koszty. <strong>Podatek liniowy 19%</strong> zwykle opłaca się powyżej 150 000 zł dochodu."
  - "<strong>ZUS:</strong> ulga na start (6 miesięcy) → preferencyjny ZUS (24 miesiące) → pełne składki albo Mały ZUS Plus, jeśli przychód nie przekroczył 120 000 zł."
  - "<strong>VAT:</strong> zwolnienie podmiotowe do 240 000 zł sprzedaży rocznie. Rejestracja od razu ma sens przy sprzedaży B2B i większych zakupach startowych."
  - "<strong>KSeF:</strong> obowiązek odbierania faktur objął wszystkich od 1 lutego 2026 roku, a obowiązek wystawiania większość firm od 1 kwietnia 2026 roku."
howTo:
  name: "Jak założyć jednoosobową działalność gospodarczą (JDG) w 2026 roku"
  totalTime: "PT2H"
  steps:
    - name: "Wybierz formę opodatkowania"
      text: "Zdecyduj między ryczałtem, skalą podatkową i podatkiem liniowym. Zmiana w trakcie roku jest możliwa tylko do 20. dnia miesiąca następującego po miesiącu pierwszego przychodu."
    - name: "Wybierz wariant składek ZUS"
      text: "Nowy przedsiębiorca ma zwykle 6 miesięcy ulgi na start, a potem 24 miesiące preferencyjnego ZUS. Później pełne składki albo Mały ZUS Plus, jeśli spełnia warunki."
    - name: "Określ status VAT"
      text: "Zwolnienie podmiotowe przysługuje do 240 000 zł sprzedaży rocznie. Rejestracja jako czynny podatnik od razu ma sens przy sprzedaży do firm i większych zakupach startowych."
    - name: "Wybierz kody PKD"
      text: "Jeden kod główny i dowolna liczba dodatkowych. PKD nie decyduje o stawce ryczałtu, ale powinno odpowiadać rzeczywistemu zakresowi działalności."
    - name: "Złóż wniosek CEIDG-1"
      text: "Wniosek wypełniasz online na biznes.gov.pl. Jest jednocześnie zgłoszeniem do urzędu skarbowego, GUS i ZUS jako płatnika składek. Podpisujesz go profilem zaufanym, podpisem kwalifikowanym albo e-dowodem."
      url: "https://www.biznes.gov.pl/pl/portal/00115"
    - name: "Zgłoś się do ubezpieczeń w ZUS"
      text: "W ciągu 7 dni od rozpoczęcia działalności złóż ZUS ZUA albo ZUS ZZA. Formularz można dołączyć do wniosku CEIDG-1 albo złożyć osobno. Sam wpis do CEIDG nie zgłasza Cię do ubezpieczeń."
    - name: "Skonfiguruj KSeF"
      text: "Nadaj uprawnienia w Krajowym Systemie e-Faktur albo udziel pełnomocnictwa biuru rachunkowemu. Sprawdź też, czy Twój program do fakturowania obsługuje certyfikat KSeF."
      url: "https://www.podatki.gov.pl/ksef/"
    - name: "Otwórz konto firmowe i zgłoś je w CEIDG"
      text: "Konto firmowe nie jest formalnie obowiązkowe, ale staje się konieczne przy transakcjach z firmami powyżej 15 000 zł oraz przy mechanizmie podzielonej płatności."
faq:
  - q: "Czy mogę założyć JDG, będąc na etacie?"
    a: "Tak, bez ograniczeń. Jeśli wynagrodzenie z etatu jest równe co najmniej minimalnemu wynagrodzeniu, z działalności opłacasz wyłącznie składkę zdrowotną. To bardzo korzystny układ przy budowaniu firmy równolegle do pracy."
  - q: "Czy mogę zmienić formę opodatkowania w trakcie roku?"
    a: "Tylko do 20. dnia miesiąca następującego po miesiącu, w którym osiągnąłeś pierwszy przychód w danym roku. Po tym terminie wybór obowiązuje do końca roku, a kolejna zmiana jest możliwa dopiero od stycznia."
  ...
  - q: "Ile kosztuje założenie JDG przez biuro rachunkowe?"
    a: "W Taxun jest to konsultacja przed startem za 199 zł netto, a nie rejestracja wykonana za Ciebie. Sama pomoc przy zakładaniu działalności jest osobno zamawianą, płatną usługą - kupujesz ją jeszcze przed podpisaniem umowy o stałą obsługę i nie musisz takiej umowy zawierać. Przechodzimy razem przez wniosek CEIDG-1 na spotkaniu online: policzone warianty opodatkowania, kod tytułu w ZUS i dostępne ulgi, kody PKD, VAT-R i uprawnienia w KSeF. Podpisujesz i wysyłasz sam - pełnomocnik nie złoży tego wniosku przez internet. Jeżeli w ciągu 30 dni od konsultacji wejdzie w życie umowa o obsługę księgową, dostajesz rabat równy zapłaconej kwocie netto na pierwszej fakturze."
...
Więcej szczegółów znajdziesz w naszym [przewodniku po ZUS przedsiębiorcy](/wiedza/zus-przedsiebiorcy-2026).
...
Szerzej opisaliśmy to w tekście [KSeF w praktyce](/wiedza/ksef-praktyczny-przewodnik).
...
**Czy mogę prowadzić JDG razem z etatem?**
Tak. Jeśli wynagrodzenie z etatu jest równe co najmniej minimalnemu wynagrodzeniu, z działalności opłacasz wyłącznie składkę zdrowotną. Jeśli jest niższe, składki społeczne z działalności są obowiązkowe.

**Jestem studentem do 26. roku życia. Czy jestem zwolniony ze składek?**
Nie w działalności gospodarczej. Zwolnienie dotyczy wyłącznie umów zlecenia. W JDG płacisz składki zgodnie z wariantem, w którym się znajdujesz.

**Czy mogę zawiesić działalność?**
Tak, w dowolnym momencie, na minimum 30 dni i bez górnego ograniczenia. W czasie zawieszenia nie płacisz składek i nie składasz plików JPK_V7.

**Co z fakturą dla firmy z UE przed rejestracją VAT-UE?**
Rejestrację VAT-UE trzeba mieć przed pierwszą taką transakcją. Jeśli wiesz, że będziesz fakturować kontrahentów z Unii, zgłoś to od razu na VAT-R.

**Czy odliczę koszty zakupów sprzed rejestracji firmy?**
W zakresie VAT jest to w pewnych sytuacjach możliwe przez korektę, natomiast w podatku dochodowym zasadą jest, że kosztem są wydatki poniesione po rozpoczęciu działalności. Wyjątkiem są środki trwałe wprowadzone do ewidencji. W praktyce większe zakupy lepiej zrobić po rejestracji.
...
Jeżeli chcesz pomocy przy samym założeniu firmy, to już osobna, płatna usługa: **konsultacja przed startem za 199 zł netto**. Kupujesz ją jeszcze przed podpisaniem umowy o stałą obsługę i nie musisz takiej umowy zawierać. Godzina online, w czasie której przechodzimy przez wniosek pole po polu: policzone warianty ryczałtu, skali i liniowego na Twoich liczbach, kod tytułu ubezpieczenia w ZUS i dostępne ulgi, kody PKD, decyzja o VAT-R i VAT-UE, uprawnienia w KSeF.

Jeżeli po konsultacji zdecydujesz się na naszą stałą obsługę i umowa wejdzie w życie w ciągu 30 dni, dostajesz **rabat równy zapłaconej kwocie netto na pierwszej fakturze**. Bez współpracy albo po tym terminie konsultacja pozostaje usługą odpłatną. Warunki opisuje [regulamin](/regulamin#jednorazowe).
...
Jeśli jesteś lub zamierzasz zostać naszym klientem, to pamiętaj, że najwięcej zyskasz, rozmawiając z nami **przed** wypełnieniem wniosku. [Napisz do nas](/kontakt) albo zajrzyj do [oferty zakładania firmy](/ksiegowosc#zakladanie-firmy).

## Źródła i podstawy prawne

- [Biznes.gov.pl - jednoosobowa działalność gospodarcza](https://www.biznes.gov.pl/pl/portal/00115) - oficjalny portal z formularzem CEIDG-1 i instrukcją.
- [ZUS - ulga na start](https://www.zus.pl/firmy/przedsiebiorco-przeczytaj/ulga-na-start) - warunki i okres trwania ulgi.
- [Biznes.gov.pl - Mały ZUS Plus](https://www.biznes.gov.pl/pl/portal/00284) - limity, warunki i zasady liczenia okresów od 2026 roku.
- [Krajowy System e-Faktur - plan wdrożenia](https://www.gov.pl/web/finanse/krajowy-system-e-faktur--plan-wdrozenia) - harmonogram obowiązkowego KSeF.
- [Biała lista podatników VAT](https://www.podatki.gov.pl/wykaz-podatnikow-vat-wyszukiwarka/) - weryfikacja rachunków bankowych kontrahentów.
- Ustawa z 11 marca 2004 r. o podatku od towarów i usług, art. 113 - zwolnienie podmiotowe i limit 240 000 zł.
- Ustawa z 20 listopada 1998 r. o zryczałtowanym podatku dochodowym od niektórych przychodów osiąganych przez osoby fizyczne, art. 12 - stawki ryczałtu.
- Ustawa z 13 października 1998 r. o systemie ubezpieczeń społecznych, art. 18a i 18c - preferencyjne składki i Mały ZUS Plus.