---
title: "Jak założyć spółkę z o.o. w 2026 - S24, notariusz, estoński CIT"
description: "Przewodnik po założeniu sp. z o.o. w 2026 roku. Wybór ścieżki S24 lub notariusz, kapitał, KRS, NIP, VAT, estoński CIT, koszty i terminy."
seoTitle: "Jak założyć spółkę z o.o. w 2026 - S24 i CIT"
pubDate: 2026-05-22
updatedDate: 2026-09-07
category: "Spółki"
tags: ["spółka z o.o.", "S24", "KRS", "estoński CIT", "zakładanie firmy"]
readingTime: 13
featured: false
author: "tomasz-bajorek"
cover: "spolka-z-oo-zalozenie.jpg"
summary:
  - "Sp. z o.o. w 2026 roku można założyć na dwa sposoby: przez <strong>S24</strong> (online, na wzorcu umowy, 1 - 3 dni robocze) albo <strong>u notariusza</strong> (pełna elastyczność umowy)."
  - "Minimalny kapitał zakładowy to <strong>5 000 zł</strong>. Nie musi być wpłacony przed rejestracją, ale musi zostać realnie wniesiony."
  - "System S24 <strong>nie pobiera podatku PCC</strong>. Spółka sama składa deklarację PCC-3 i płaci podatek w ciągu 14 dni. To jeden z najczęstszych błędów."
  - "Po rejestracji: <strong>NIP-8</strong> w 21 dni, aktywacja skrzynki do <strong>e-Doręczeń</strong>, VAT-R przed pierwszą czynnością opodatkowaną, konfiguracja KSeF, rachunek firmowy."
  - "<strong>Estoński CIT</strong> to opcja, w której podatek płacisz dopiero przy wypłacie zysku. Nowe spółki są zwolnione z warunku zatrudnienia przez pierwsze trzy lata."
howTo:
  name: "Jak założyć spółkę z ograniczoną odpowiedzialnością (sp. z o.o.) w 2026"
  totalTime: "P3D"
  steps:
    - name: "Wybierz ścieżkę: S24 albo notariusz"
      text: "S24 jest szybszy i tańszy, ale opiera się na wzorcu umowy. Notariusz daje pełną elastyczność zapisów i pozwala wnieść aport, ale kosztuje więcej."
    - name: "Przygotuj umowę spółki"
      text: "Ustal wspólników, kapitał zakładowy (minimum 5 000 zł), liczbę i wartość udziałów, skład zarządu, sposób reprezentacji oraz kody PKD. W S24 wybierasz spośród gotowych klauzul."
    - name: "Zarejestruj spółkę w KRS"
      text: "W S24 wniosek składasz online i podpisujesz profilem zaufanym albo podpisem kwalifikowanym. We wniosku podajesz też dane do utworzenia adresu do e-Doręczeń i wskazujesz administratora skrzynki. Przy akcie notarialnym wniosek składa notariusz przez Portal Rejestrów Sądowych."
      url: "https://ekrs.ms.gov.pl/"
    - name: "Złóż deklarację PCC-3"
      text: "W ciągu 14 dni od zawarcia umowy spółki złóż PCC-3 i zapłać 0,5% od kapitału zakładowego pomniejszonego o opłatę sądową. System S24 nie robi tego za Ciebie."
    - name: "Uzupełnij dane w NIP-8"
      text: "W ciągu 21 dni od wpisu do KRS zgłoś dane uzupełniające na formularzu NIP-8. Jeśli spółka zgłasza się jako płatnik składek ZUS, termin skraca się do 7 dni."
    - name: "Aktywuj skrzynkę do e-Doręczeń"
      text: "Sam wpis nie uruchamia adresu. Administrator wskazany we wniosku loguje się do panelu, podaje e-mail do powiadomień, akceptuje regulamin i aktywuje skrzynkę. Dopiero wtedy adres trafia do bazy adresów elektronicznych i zaczyna działać."
      url: "https://www.gov.pl/web/e-doreczenia"
    - name: "Otwórz rachunek firmowy"
      text: "Większość banków pozwala otworzyć konto online na podstawie danych z KRS. Rachunek jest potrzebny do wniesienia kapitału, mechanizmu podzielonej płatności i wpisu na białą listę VAT."
    - name: "Skonfiguruj KSeF"
      text: "Nadaj uprawnienia w Krajowym Systemie e-Faktur członkom zarządu i biuru rachunkowemu. Jeśli spółka nie ma pieczęci kwalifikowanej, pierwszą osobę z pełnymi uprawnieniami wskazujesz zgłoszeniem ZAW-FA do naczelnika urzędu skarbowego. Obowiązek wystawiania faktur w KSeF objął większość przedsiębiorców od 1 kwietnia 2026 roku."
      url: "https://www.podatki.gov.pl/ksef/"
    - name: "Wybierz formę opodatkowania CIT"
      text: "Standardowy CIT 19% albo 9% dla małego podatnika, ewentualnie estoński CIT. Zawiadomienie ZAW-RD składasz do końca pierwszego miesiąca roku podatkowego."
faq:
  - q: "Ile trwa założenie sp. z o.o. w trybie S24?"
    a: "Ustawa nakazuje sądowi rozpoznać wniosek w ciągu jednego dnia od jego wpływu, ale jest to termin instrukcyjny. W praktyce rejestracja zajmuje od jednego do trzech dni roboczych, o ile wniosek nie zawiera błędów formalnych."
  - q: "Czy muszę wpłacić kapitał zakładowy przed rejestracją?"
    a: "Nie. Do wniosku wystarczy oświadczenie zarządu o wniesieniu wkładów. Kapitał trzeba jednak realnie wnieść, czyli przelać na rachunek spółki. Środki pozostają majątkiem spółki i można je wykorzystać na jej działalność."
  - q: "Ile kosztuje założenie sp. z o.o. w S24?"
    a: "Opłata sądowa wynosi 250 zł, a podatek PCC przy kapitale 5 000 zł to 24 zł. Razem 274 zł. Od 29 listopada 2025 roku nie ma już opłaty 100 zł za ogłoszenie w Monitorze Sądowym i Gospodarczym, bo zniesiono sam obowiązek publikacji. Do tego dochodzi kapitał zakładowy, który zostaje w spółce."
  - q: "Co to jest estoński CIT i czy się opłaca?"
    a: "To ryczałt od dochodów spółek, w którym podatek płacisz dopiero przy wypłacie zysku do wspólników, a nie w trakcie roku. Opłaca się spółkom, które reinwestują zyski. Jeśli wspólnicy wypłacają wszystko na bieżąco, korzyść jest znacznie mniejsza."
  - q: "Czy mogę być jedynym wspólnikiem i jedynym członkiem zarządu?"
    a: "Tak, jednoosobowa sp. z o.o. jest dopuszczalna. Pamiętaj jednak, że jedyny wspólnik podlega ubezpieczeniom w ZUS na takich zasadach jak osoba prowadząca działalność gospodarczą."
---
...
Rejestracja online przez portal [ekrs.ms.gov.pl](https://ekrs.ms.gov.pl/), na gotowym wzorcu umowy.
...
1. **Zaloguj się** na [ekrs.ms.gov.pl](https://ekrs.ms.gov.pl/) profilem zaufanym albo podpisem kwalifikowanym.
...
**Dlatego oferujemy konsultację przed startem za 499 zł netto + VAT.** Jeżeli w ciągu 30 dni od konsultacji podpiszesz z nami umowę na stałą obsługę księgową, dostajesz rabat równy zapłaconej kwocie netto na pierwszą fakturę; bez współpracy albo po tym terminie konsultacja pozostaje usługą odpłatną. W zakresie:
...
- [ekrs.ms.gov.pl](https://ekrs.ms.gov.pl/) - portal rejestracji spółek w trybie S24.
- [Biznes.gov.pl - spółka z o.o.](https://www.biznes.gov.pl/pl/portal/00115) - przewodnik po formie prawnej i procedurze rejestracji.
- [Biznes.gov.pl - estoński CIT](https://www.biznes.gov.pl/pl/portal/001171) - warunki, terminy i zasady rozliczania ryczałtu od dochodów spółek.
- [Podatki.gov.pl - CIT estoński](https://www.podatki.gov.pl/podatki-firmowe/cit/cit-estonski/informacje-podstawowe-cit-estonski) - oficjalne wyjaśnienia Ministerstwa Finansów.
...
- [Ustawa o doręczeniach elektronicznych](https://www.gov.pl/web/e-doreczenia) - obowiązek posiadania adresu do e-Doręczeń i zasady jego zakładania przy wpisie do KRS.
